...
function Blogs() {
  return (
    <section class="text-gray-dark body-font bg-dark overflow-hidden">
      <p className='text-white text-4xl py-24 text-center'>Blogs</p>
    <div class="container px-5 py-8 mx-auto">
      <div class="-my-8 divide-y-2 divide-gray p-8">
